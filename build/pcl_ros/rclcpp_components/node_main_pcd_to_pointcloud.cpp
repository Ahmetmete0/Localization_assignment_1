...
#define NODE_MAIN_LOGGER_NAME "pcd_to_pointcloud"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpcd_to_pointcloud_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pcl_ros::PCDPublisher>";
