...
#define NODE_MAIN_LOGGER_NAME "pcd_to_pointcloud_lib_2"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "pcd_to_pointcloud_lib_2";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pcl_ros_2::PCDPublisher_2>";
